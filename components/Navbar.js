...
const Navbar = () => {
    ...
    const [resizeinput, setresizeinput] = useState("none");
    const [fadeinput, setfadeinput] = useState(0);
            ...
            <div className={`rightnav  ${sun}`}>
                <div className="button" id="button" onClick={() => switcher()}>
                    <div className="mover" id="mover">
                        ...
                        <svg className="icon moon" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#F3F6F9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
                    </div>
                </div>
            ...
            <div className="floatmenu">
                <OutsideClickHandler
                    ...
                    <div className="floatmenuinside">
                        ...
                        <FloatMenu animaWidth={animaWidth} resizeinput={resizeinput} fadeinput={fadeinput}/>
                    </div>
                </OutsideClickHandler>
            </div>
