...
const DarkModeBtn1 = () => {
    ...
    return (
        <div className="compdiv">
            <p style={{fontFamily: 'monospace', position:'fixed', top:'-10px', left:"0", color:'gray'}}>
                <strong>Toggle vhjhvjvDark Mode Skew</strong>
                <br/>by 
                <a href="http://errbint.net" style={{color:'orange'}}>Errbint.NET</a>
            </p>
